window.addEventListener('load', function() {
    ...
    .then(data => { // access the data IF the promise is fulfilled
      ...
      for (let index = 0; index < data.meals.length; index++) { // Going through the list of Meals and making elements for each to display on the webpage
      ...
      searchBar.addEventListener('keyup',(e)=>{ //searches the input and displays relevant boxes
        ...
        for (let index = 0; index < data.meals.length; index++) { // Goes through the loop and only displays the items that contains the search bar input
